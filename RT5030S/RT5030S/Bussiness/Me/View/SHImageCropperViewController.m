//
//  SHImageCropperViewController.m
...
@interface SHImageCropperViewController ()
...
@implementation SHImageCropperViewController
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(SHImageCropperDelegate)]) {
...
-(UIImage *)getSubImage{
    ...
    if (IPHONE4 & self.isCamera) {// 是否iphone4 & 是拍照图片
          smallImage= [self image:smallImage rotation:UIImageOrientationRight];
    }
    return smallImage;
}
