...
-(void)setYLabels:(NSArray *)yLabels
{
    ...
    _xLabelWidth = (self.frame.size.width - chartMargin - 30.0 - ([yLabels count] -1) * xLabelMargin)/yLabels.count;
    UIView * view = [[UIView alloc]initWithFrame:CGRectMake(30.0+_xLabelWidth/2, self.frame.size.height - 30.0, 6 * (xLabelMargin + _xLabelWidth), 1)];
